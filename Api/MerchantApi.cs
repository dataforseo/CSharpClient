...
namespace DataForSeo.Client.Api
{
    ...
    #pragma warning restore 8618
        ...
        public virtual async Task<MerchantGoogleSellersTaskGetHtmlResponseInfo> GoogleSellersTaskGetHtmlAsync(string id)
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/google/sellers/task_get/html/{id}"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantGoogleSellersTaskGetHtmlResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantGoogleProductSpecTaskPostResponseInfo> GoogleProductSpecTaskPostAsync(IEnumerable<MerchantGoogleProductSpecTaskPostRequestInfo> payload)
        {
            using (var request = new HttpRequestMessage())
            {
                var json = JsonConvert.SerializeObject(payload, _settings);
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/google/product_spec/task_post";
                urlBuilder.Append(path);
                var url = urlBuilder.ToString();
                request.RequestUri = new Uri(url, UriKind.RelativeOrAbsolute);
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantGoogleProductSpecTaskPostResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantGoogleProductSpecTasksReadyResponseInfo> GoogleProductSpecTasksReadyAsync()
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/google/product_spec/tasks_ready"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantGoogleProductSpecTasksReadyResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantGoogleProductSpecTaskGetHtmlResponseInfo> GoogleProductSpecTaskGetHtmlAsync(string id)
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/google/product_spec/task_get/html/{id}"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantGoogleProductSpecTaskGetHtmlResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantAmazonReviewsTaskPostResponseInfo> AmazonReviewsTaskPostAsync(IEnumerable<MerchantAmazonReviewsTaskPostRequestInfo> payload)
        {
            using (var request = new HttpRequestMessage())
            {
                var json = JsonConvert.SerializeObject(payload, _settings);
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/amazon/reviews/task_post";
                urlBuilder.Append(path);
                var url = urlBuilder.ToString();
                request.RequestUri = new Uri(url, UriKind.RelativeOrAbsolute);
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantAmazonReviewsTaskPostResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantAmazonReviewsTasksReadyResponseInfo> AmazonReviewsTasksReadyAsync()
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/amazon/reviews/tasks_ready"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantAmazonReviewsTasksReadyResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantAmazonReviewsTaskGetAdvancedResponseInfo> AmazonReviewsTaskGetAdvancedAsync(string id)
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/amazon/reviews/task_get/advanced/{id}"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantAmazonReviewsTaskGetAdvancedResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<MerchantAmazonReviewsTaskGetHtmlResponseInfo> AmazonReviewsTaskGetHtmlAsync(string id)
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/merchant/amazon/reviews/task_get/html/{id}"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<MerchantAmazonReviewsTaskGetHtmlResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }

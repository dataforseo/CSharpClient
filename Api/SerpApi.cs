...
namespace DataForSeo.Client.Api
{
    ...
    #pragma warning restore 8618
        ...
        public virtual async Task<SerpGoogleLiteTaskPostResponseInfo> GoogleLiteTaskPostAsync(IEnumerable<SerpGoogleLiteTaskPostRequestInfo> payload)
        {
            using (var request = new HttpRequestMessage())
            {
                var json = JsonConvert.SerializeObject(payload, _settings);
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/task_post";
                urlBuilder.Append(path);
                var url = urlBuilder.ToString();
                request.RequestUri = new Uri(url, UriKind.RelativeOrAbsolute);
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteTaskPostResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<SerpGoogleLiteTasksReadyResponseInfo> GoogleLiteTasksReadyAsync()
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/tasks_ready"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteTasksReadyResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<SerpGoogleLiteTasksFixedResponseInfo> GoogleLiteTasksFixedAsync()
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/tasks_fixed"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteTasksFixedResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<SerpGoogleLiteTaskGetAdvancedResponseInfo> GoogleLiteTaskGetAdvancedAsync(string id)
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/task_get/advanced/{id}"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteTaskGetAdvancedResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<SerpGoogleLiteTaskGetHtmlResponseInfo> GoogleLiteTaskGetHtmlAsync(string id)
        {
            using (var request = new HttpRequestMessage())
            {
                request.Method = new HttpMethod("GET");
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/task_get/html/{id}"
                ...
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteTaskGetHtmlResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<SerpGoogleLiteLiveAdvancedResponseInfo> GoogleLiteLiveAdvancedAsync(IEnumerable<SerpGoogleLiteLiveAdvancedRequestInfo> payload)
        {
            using (var request = new HttpRequestMessage())
            {
                var json = JsonConvert.SerializeObject(payload, _settings);
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/live/advanced";
                urlBuilder.Append(path);
                var url = urlBuilder.ToString();
                request.RequestUri = new Uri(url, UriKind.RelativeOrAbsolute);
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteLiveAdvancedResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }
        ...
        public virtual async Task<SerpGoogleLiteLiveHtmlResponseInfo> GoogleLiteLiveHtmlAsync(IEnumerable<SerpGoogleLiteLiveHtmlRequestInfo> payload)
        {
            using (var request = new HttpRequestMessage())
            {
                var json = JsonConvert.SerializeObject(payload, _settings);
                ...
                if (!string.IsNullOrEmpty(_baseUrl))
                    urlBuilder.Append(_baseUrl);
                var path = "/v3/serp/google/lite/live/html";
                urlBuilder.Append(path);
                var url = urlBuilder.ToString();
                request.RequestUri = new Uri(url, UriKind.RelativeOrAbsolute);
                using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
                {
                    ...
                    if (status == 200)
                    {
                        var objectResponse = await ReadObjectResponseAsync<SerpGoogleLiteLiveHtmlResponseInfo>(response, headers).ConfigureAwait(false);
                        return objectResponse.Object;
                    }

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseBusinessDataSerpElementItem](./BaseBusinessDataSerpElementItem.md) → [TrustpilotSearchOrganicBusinessDataSerpElementItem](./TrustpilotSearchOrganicBusinessDataSerpElementItem.md)

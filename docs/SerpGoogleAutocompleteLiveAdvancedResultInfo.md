...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpGoogleAutocompleteLiveAdvancedResultInfo](./SerpGoogleAutocompleteLiveAdvancedResultInfo.md)
...
```csharp
public ICollection<SerpGoogleAutocompleteAdvancedItem> Items { get; set; }
```

#### Property Value

[ICollection&lt;SerpGoogleAutocompleteAdvancedItem&gt;](./SerpGoogleAutocompleteAdvancedItem.md)<br>

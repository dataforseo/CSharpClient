...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleEventsLiveAdvancedRequestInfo](./dataforseo.client.models.requests.serpgoogleeventsliveadvancedrequestinfo.md)

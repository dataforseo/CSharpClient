...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [KeywordsDataErrorsRequestInfo](./dataforseo.client.models.requests.keywordsdataerrorsrequestinfo)

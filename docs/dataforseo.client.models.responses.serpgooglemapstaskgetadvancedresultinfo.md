...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleMapsTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpgooglemapstaskgetadvancedresultinfo.md)

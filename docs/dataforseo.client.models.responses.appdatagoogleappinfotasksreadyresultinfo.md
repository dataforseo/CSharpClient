...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataGoogleAppInfoTasksReadyResultInfo](./dataforseo.client.models.responses.appdatagoogleappinfotasksreadyresultinfo)

...
**EndpointAdvanced** | **string** | URL for collecting the results of the Google App Reviews task |[optional]|
**EndpointHtml** | **string** | URL for collecting the results of the Google App Reviews HTML task<br>if HTML tasks are not supported in the specified endpoint, the value will be null |[optional]|
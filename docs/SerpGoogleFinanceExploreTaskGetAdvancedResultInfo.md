...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpGoogleFinanceExploreTaskGetAdvancedResultInfo](./SerpGoogleFinanceExploreTaskGetAdvancedResultInfo.md)
...
```csharp
public SerpGoogleFinanceExploreTaskGetAdvancedResultInfo()
```

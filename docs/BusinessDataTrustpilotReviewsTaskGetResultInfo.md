...
**ReviewsCount** | **string** | the total number of reviews |[optional]|
**Rating** | **object** | rating of the corresponding business entity<br>popularity rate based on reviews and displayed in SERP |[optional]|

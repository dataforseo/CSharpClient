...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingOrganicLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpbingorganicliveadvancedresultinfo)

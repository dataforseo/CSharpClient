...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBaiduOrganicTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpbaiduorganictaskgetadvancedresultinfo)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [KeywordsDataGoogleAdsLocationsResultInfo](./dataforseo.client.models.responses.keywordsdatagoogleadslocationsresultinfo)

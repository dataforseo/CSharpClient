...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpSeznamOrganicTaskGetHtmlResultInfo](./dataforseo.client.models.responses.serpseznamorganictaskgethtmlresultinfo.md)

...
**SeType** | **string** | type of search engine<br>example: products |[optional]|
**DatePosted** | **string** | date when the task was posted (in the UTC format) |[optional]|
**Tag** | **string** | user-defined task identifier |[optional]|
**EndpointAdvanced** | **string** | URL for collecting the results of Google Shopping Products Advanced task |[optional]|
**EndpointHtml** | **string** | URL for collecting the results of Google Shopping Products HTML task |[optional]|
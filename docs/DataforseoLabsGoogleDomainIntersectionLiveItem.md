...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [DataforseoLabsGoogleDomainIntersectionLiveItem](./DataforseoLabsGoogleDomainIntersectionLiveItem.md)
...
```csharp
public DataforseoLabsGoogleDomainIntersectionLiveItem()
```

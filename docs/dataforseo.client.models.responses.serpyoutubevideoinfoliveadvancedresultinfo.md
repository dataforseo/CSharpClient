...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYoutubeVideoInfoLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpyoutubevideoinfoliveadvancedresultinfo.md)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [KeywordsDataDataforseoTrendsExploreLiveResultInfo](./KeywordsDataDataforseoTrendsExploreLiveResultInfo.md)
...
```csharp
public KeywordsDataDataforseoTrendsExploreLiveResultInfo()
```

...
**LocationNameParent** | **string** | <em>the name of the superordinate location</em><br>example:<br><code>'location_code': 9041134,<br>'location_name': 'Vienna International Airport,Lower Austria,Austria',<br>'location_name_parent': 'Lower Austria,Austria'</code> |[optional]|

...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results</em><br>contains types of search results (<code>items</code>) found.<br>possible item types:<br><code>chat_gpt_text</code>, <code>chat_gpt_table</code>, <code>chat_gpt_navigation_list</code>, <code>chat_gpt_images</code>, <code>chat_gpt_local_businesses</code>, <code>chat_gpt_products</code> |[optional]|
**ItemsCount** | **long?** | <em>the number of results returned in the <strong><code>items</code></strong> array</em> |[optional]|
**Items** | **IEnumerable<BaseChatGptLlmScraperElementItem>** | <em>items present in the element</em> |[optional]|
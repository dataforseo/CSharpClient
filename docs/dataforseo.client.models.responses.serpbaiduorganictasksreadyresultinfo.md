...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBaiduOrganicTasksReadyResultInfo](./dataforseo.client.models.responses.serpbaiduorganictasksreadyresultinfo.md)

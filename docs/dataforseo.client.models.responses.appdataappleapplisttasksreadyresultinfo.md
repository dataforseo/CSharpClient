...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataAppleAppListTasksReadyResultInfo](./dataforseo.client.models.responses.appdataappleapplisttasksreadyresultinfo)

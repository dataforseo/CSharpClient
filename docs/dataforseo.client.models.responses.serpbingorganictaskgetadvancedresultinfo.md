...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingOrganicTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpbingorganictaskgetadvancedresultinfo)

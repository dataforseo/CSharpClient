...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpGoogleEventsTaskGetAdvancedResultInfo](./SerpGoogleEventsTaskGetAdvancedResultInfo.md)

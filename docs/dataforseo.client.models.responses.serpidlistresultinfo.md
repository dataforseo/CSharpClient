...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpIdListResultInfo](./dataforseo.client.models.responses.serpidlistresultinfo)

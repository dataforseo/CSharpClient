...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [KeywordsDataBingSearchVolumeLiveRequestInfo](./dataforseo.client.models.requests.keywordsdatabingsearchvolumeliverequestinfo.md)

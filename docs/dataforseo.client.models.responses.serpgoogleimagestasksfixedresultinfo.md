...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleImagesTasksFixedResultInfo](./dataforseo.client.models.responses.serpgoogleimagestasksfixedresultinfo)

...
```csharp
public class SerpGoogleDatasetInfoTasksReadyResultInfo
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleDatasetInfoTasksReadyResultInfo](./dataforseo.client.models.responses.serpgoogledatasetinfotasksreadyresultinfo.md)
...
```csharp
public SerpGoogleDatasetInfoTasksReadyResultInfo()
```

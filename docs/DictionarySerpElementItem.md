...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseSerpElementItem](./BaseSerpElementItem.md) → [DictionarySerpElementItem](./DictionarySerpElementItem.md)

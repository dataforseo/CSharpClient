...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantIdListResultInfo](./dataforseo.client.models.responses.merchantidlistresultinfo)

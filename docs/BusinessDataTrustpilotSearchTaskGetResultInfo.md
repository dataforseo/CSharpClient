...
**Items** | **IEnumerable<TrustpilotSearchOrganic>** | <em>found reviews</em><br>you can get more results by using the <code>depth</code> parameter when setting a task |[optional]|
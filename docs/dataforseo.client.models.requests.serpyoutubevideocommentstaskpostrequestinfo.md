...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYoutubeVideoCommentsTaskPostRequestInfo](./dataforseo.client.models.requests.serpyoutubevideocommentstaskpostrequestinfo.md)

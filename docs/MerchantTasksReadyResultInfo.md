...
**EndpointAdvanced** | **string** | <em>URL for collecting the results of Amazon Sellers Advanced task</em> |[optional]|
**EndpointHtml** | **string** | <em>URL for collecting the results of Amazon Sellers HTML task</em> |[optional]|
...
**EndpointHtml** | **string** | URL for collecting the results of the Apple app_searches HTML task<br>if HTML tasks are not supported in the specified endpoint, the value will be null |[optional]|
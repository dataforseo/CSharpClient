...
**MoneySpent** | **double?** | <em>cost of AI tokens, USD</em><br>the price charged by the third-party AI model provider for according to its <a href='https://ai.google.dev/gemini-api/docs/pricing' target='_blank'>Pricing</a> |[optional]|

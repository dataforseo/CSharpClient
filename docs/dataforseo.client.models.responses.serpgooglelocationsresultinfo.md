...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleLocationsResultInfo](./dataforseo.client.models.responses.serpgooglelocationsresultinfo)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BusinessDataYelpSearchTaskGetResultInfo](./dataforseo.client.models.responses.businessdatayelpsearchtaskgetresultinfo)

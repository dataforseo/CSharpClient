...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleMapsLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgooglemapsliveadvancedresultinfo)

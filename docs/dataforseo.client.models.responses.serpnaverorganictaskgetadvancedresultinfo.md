...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpNaverOrganicTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpnaverorganictaskgetadvancedresultinfo.md)
...
```csharp
public SerpNaverOrganicTaskGetAdvancedResultInfo()
```

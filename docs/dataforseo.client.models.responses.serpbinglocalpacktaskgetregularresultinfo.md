...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingLocalPackTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpbinglocalpacktaskgetregularresultinfo)

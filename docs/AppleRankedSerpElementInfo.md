...
**SerpItem** | **AppDataAppStoreSearchOrganicSerpElementItem** | contains data on the SERP element<br>the list of supported SERP elements can be found below |[optional]|

...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>ads_muti_account_advertiser</code>, <code>ads_advertiser</code>, <code>ads_domain</code> |[optional]|
...
**Items** | **IEnumerable<BaseSerpApiAdsAdvertiserElementItem>** | <em>items of the element</em> |[optional]|
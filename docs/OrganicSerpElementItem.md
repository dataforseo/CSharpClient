...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseSerpElementItem](./BaseSerpElementItem.md) → [OrganicSerpElementItem](./OrganicSerpElementItem.md)
...
[ICollection&lt;RelatedResult&gt;](./RelatedResult.md)<br>

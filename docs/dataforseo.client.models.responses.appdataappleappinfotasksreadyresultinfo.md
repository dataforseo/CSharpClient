...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataAppleAppInfoTasksReadyResultInfo](./dataforseo.client.models.responses.appdataappleappinfotasksreadyresultinfo)

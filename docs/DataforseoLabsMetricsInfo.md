...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [DataforseoLabsMetricsInfo](./DataforseoLabsMetricsInfo.md)
...
```csharp
public Nullable<int> IsUp { get; set; }
```
...
### **ClickstreamGenderDistribution**

```csharp
public IDictionary<string, Nullable<long>> ClickstreamGenderDistribution { get; set; }
```
...
### **ClickstreamAgeDistribution**

```csharp
public IDictionary<string, Nullable<long>> ClickstreamAgeDistribution { get; set; }
```

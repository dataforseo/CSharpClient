...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleOrganicLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogleorganicliveadvancedresultinfo)

...
```csharp
public class AppendixSerpsRatesDataInfo
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [AppendixSerpsRatesDataInfo](./AppendixSerpsRatesDataInfo.md)
...
```csharp
public AppendixSerpsRatesDataInfo()
```

...
**Offset** | **int?** | offset in the results array of the returned mentions data<br>offset specified in the reqest |[optional]|
...
**Items** | **IEnumerable<AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveItem>** | contains relevant mentions data |[optional]|
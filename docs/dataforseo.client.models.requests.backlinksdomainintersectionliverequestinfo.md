...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BacklinksDomainIntersectionLiveRequestInfo](./dataforseo.client.models.requests.backlinksdomainintersectionliverequestinfo)

...
**SeType** | **string** | <em>type of search engine</em><br>can take the following values: <code>organic</code> |[optional]|
...
**EndpointAdvanced** | **string** | <em>URL for collecting the results of the Amazon Products Advanced task</em> |[optional]|
**EndpointHtml** | **string** | <em>URL for collecting the results of the Amazon Products HTML task</em> |[optional]|
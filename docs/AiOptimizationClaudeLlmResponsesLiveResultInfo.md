...
**ReasoningTokens** | **int?** | number of reasoning tokens<br>total count of tokens used to generate reasoning content |[optional]|
...
**Items** | **IEnumerable<BaseAiOptimizationLlmResponseElementItem>** | array of response items<br>contains structured AI response data |[optional]|

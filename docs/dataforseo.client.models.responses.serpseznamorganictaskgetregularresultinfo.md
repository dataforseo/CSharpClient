...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpSeznamOrganicTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpseznamorganictaskgetregularresultinfo)

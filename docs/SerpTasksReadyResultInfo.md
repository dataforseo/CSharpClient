...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpTasksReadyResultInfo](./SerpTasksReadyResultInfo.md)
...
```csharp
public SerpTasksReadyResultInfo()
```

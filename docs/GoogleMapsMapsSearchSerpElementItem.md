...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseGoogleMapsSerpElementItem](./BaseGoogleMapsSerpElementItem.md) → [GoogleMapsMapsSearchSerpElementItem](./GoogleMapsMapsSearchSerpElementItem.md)

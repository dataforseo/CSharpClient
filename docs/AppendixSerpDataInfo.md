...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [AppendixSerpDataInfo](./AppendixSerpDataInfo.md)
...
```csharp
public Nullable<double> TasksReadyQueue { get; set; }
```

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleImagesLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogleimagesliveadvancedresultinfo)

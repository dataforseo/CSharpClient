...
**LocationNameParent** | **string** | <em>the name of the superordinate location</em><br>example:<br>`'location_name': 'Arkansas,United States'`,<br>`'location_name_parent': 'United States'` |[optional]|

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleNewsTaskGetHtmlResultInfo](./dataforseo.client.models.responses.serpgooglenewstaskgethtmlresultinfo)

...
**SearchResults** | **IEnumerable<ChatgptSearchResult>** | array of search resultsall web search outputs the model retrieved when looking up information, including duplicates and unused entries |[optional]|
...
**BrandEntities** | **IEnumerable<ChatGptBrandEntity>** | array of brand entitiescontains information on brands mentioned in the response |[optional]|
**SeResultsCount** | **long?** | total number of results |[optional]|
**ItemTypes** | **IEnumerable<string>** | types of search resultscontains types of search results (items) found in SERP.possible item types:chat_gpt_text, chat_gpt_table, chat_gpt_navigation_list, chat_gpt_images, chat_gpt_local_businesses, chat_gpt_products |[optional]|

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYoutubeVideoSubtitlesTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpyoutubevideosubtitlestaskgetadvancedresultinfo.md)

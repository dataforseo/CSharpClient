...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BusinessDataGoogleExtendedReviewsTaskGetItem](./BusinessDataGoogleExtendedReviewsTaskGetItem.md)

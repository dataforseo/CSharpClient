...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleDatasetSearchLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogledatasetsearchliveadvancedresultinfo)

...
**EppStatusCodes** | **IEnumerable<string>** | extensive provisioning protocol status codesthe status of a domain name registration as defined by ICANN |[optional]|
**Tld** | **string** | top-level domaintop-level domain in the DNS root zone |[optional]|
**Registered** | **bool?** | domain registration statusif false, the domain name registration has expiredNote: expired domains will remain in the database for only a short period of time |[optional]|

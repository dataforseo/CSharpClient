...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleLocalFinderLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgooglelocalfinderliveadvancedresultinfo)

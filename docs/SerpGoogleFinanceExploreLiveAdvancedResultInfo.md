...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpGoogleFinanceExploreLiveAdvancedResultInfo](./SerpGoogleFinanceExploreLiveAdvancedResultInfo.md)
...
```csharp
public SerpGoogleFinanceExploreLiveAdvancedResultInfo()
```

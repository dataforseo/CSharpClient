...
**NewMentions** | **int?** | <em>new LLM mentions</em><br>indicates the LLM responses that contain the target at the <code>date_to</code> timestamp, did not contain it at the <code>date_from</code> timestamp |[optional]|
**LostMentions** | **int?** | <em>lost LLM mentions</em><br>indicates the LLM responses that contained the specified target at the <code>date_from</code> timestamp, do not contain it at the <code>date_to</code> timestamp |[optional]|

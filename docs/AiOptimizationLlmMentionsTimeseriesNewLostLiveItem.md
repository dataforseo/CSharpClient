...
**NewMentions** | **int?** | new LLM mentions<br>indicates the LLM responses that contain the target at the date_to timestamp, did not contain it at the date_from timestamp |[optional]|
**LostMentions** | **int?** | lost LLM mentions<br>indicates the LLM responses that contained the specified target at the date_from timestamp, do not contain it at the date_to timestamp |[optional]|

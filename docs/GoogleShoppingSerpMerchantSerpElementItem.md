...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseMerchantSerpElementItem](./BaseMerchantSerpElementItem.md) → [GoogleShoppingSerpMerchantSerpElementItem](./GoogleShoppingSerpMerchantSerpElementItem.md)

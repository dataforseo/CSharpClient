...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingOrganicTasksFixedResultInfo](./dataforseo.client.models.responses.serpbingorganictasksfixedresultinfo)

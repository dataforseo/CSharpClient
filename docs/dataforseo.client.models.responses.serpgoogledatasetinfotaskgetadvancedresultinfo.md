...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleDatasetInfoTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogledatasetinfotaskgetadvancedresultinfo)

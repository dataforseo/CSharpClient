...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [KeywordsDataBingSearchVolumeLiveResultInfo](./dataforseo.client.models.responses.keywordsdatabingsearchvolumeliveresultinfo.md)

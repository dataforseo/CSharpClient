...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>gemini_text</code>, <code>gemini_table</code>, <code>gemini_images</code> |[optional]|
**ItemsCount** | **long?** | <em>the number of results returned in the <strong><code>items</code></strong> array</em> |[optional]|
**Items** | **IEnumerable<BaseGeminiLlmScraperElementItem>** | <em>items present in the element</em> |[optional]|
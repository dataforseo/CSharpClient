...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BusinessDataYelpReviewsTaskPostRequestInfo](./dataforseo.client.models.requests.businessdatayelpreviewstaskpostrequestinfo)

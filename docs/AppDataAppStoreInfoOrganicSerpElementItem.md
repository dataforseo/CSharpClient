...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseAppDataSerpElementItem](./BaseAppDataSerpElementItem.md) → [AppDataAppStoreInfoOrganicSerpElementItem](./AppDataAppStoreInfoOrganicSerpElementItem.md)

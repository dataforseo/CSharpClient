...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo](./SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo.md)
...
```csharp
public SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo()
```

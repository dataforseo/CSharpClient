...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [OnPageDuplicateTagsRequestInfo](./dataforseo.client.models.requests.onpageduplicatetagsrequestinfo.md)

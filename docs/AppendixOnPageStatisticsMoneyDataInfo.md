# AppendixOnPageStatisticsMoneyDataInfo

Namespace: DataForSeo.Client.Models

```csharp
public class AppendixOnPageStatisticsMoneyDataInfo
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [AppendixOnPageStatisticsMoneyDataInfo](./AppendixOnPageStatisticsMoneyDataInfo.md)
...
```csharp
public AppendixOnPageStatisticsMoneyDataInfo()
```

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYahooOrganicTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpyahooorganictaskgetadvancedresultinfo)

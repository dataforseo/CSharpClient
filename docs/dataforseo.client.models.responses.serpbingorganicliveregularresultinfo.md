...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingOrganicLiveRegularResultInfo](./dataforseo.client.models.responses.serpbingorganicliveregularresultinfo)

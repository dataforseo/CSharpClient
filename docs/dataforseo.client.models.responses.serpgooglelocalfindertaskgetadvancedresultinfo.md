...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleLocalFinderTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpgooglelocalfindertaskgetadvancedresultinfo)

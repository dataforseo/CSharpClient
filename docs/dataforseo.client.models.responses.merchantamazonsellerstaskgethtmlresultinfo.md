...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantAmazonSellersTaskGetHtmlResultInfo](./dataforseo.client.models.responses.merchantamazonsellerstaskgethtmlresultinfo.md)

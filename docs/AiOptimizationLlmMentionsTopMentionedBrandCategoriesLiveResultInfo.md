...
**Items** | **IEnumerable<AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveItem>** | <em>individual brand categories results</em><br>array containing detailed mention metrics for each of the found brand categories |[optional]|
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantAmazonAsinTaskGetHtmlResultInfo](./dataforseo.client.models.responses.merchantamazonasintaskgethtmlresultinfo.md)
...
```csharp
public MerchantAmazonAsinTaskGetHtmlResultInfo()
```

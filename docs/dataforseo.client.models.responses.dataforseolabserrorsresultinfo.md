...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [DataforseoLabsErrorsResultInfo](./dataforseo.client.models.responses.dataforseolabserrorsresultinfo)

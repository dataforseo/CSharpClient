...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseResponseTaskInfo](./BaseResponseTaskInfo.md) → [AppendixWebhookResendTaskInfo](./AppendixWebhookResendTaskInfo.md)
...
```csharp
public AppendixWebhookResendTaskInfo()
```

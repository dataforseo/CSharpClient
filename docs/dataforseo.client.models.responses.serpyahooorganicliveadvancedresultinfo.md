...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYahooOrganicLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpyahooorganicliveadvancedresultinfo.md)
...
```csharp
public SerpYahooOrganicLiveAdvancedResultInfo()
```

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantAmazonAsinTaskPostRequestInfo](./dataforseo.client.models.requests.merchantamazonasintaskpostrequestinfo.md)

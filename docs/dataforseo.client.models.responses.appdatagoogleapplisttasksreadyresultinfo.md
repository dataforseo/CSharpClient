...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataGoogleAppListTasksReadyResultInfo](./dataforseo.client.models.responses.appdatagoogleapplisttasksreadyresultinfo)

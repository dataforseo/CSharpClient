...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BacklinksDomainPagesSummaryLiveItem](./dataforseo.client.models.backlinksdomainpagessummaryliveitem.md)

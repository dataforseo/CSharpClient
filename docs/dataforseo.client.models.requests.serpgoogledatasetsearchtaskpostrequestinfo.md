...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleDatasetSearchTaskPostRequestInfo](./dataforseo.client.models.requests.serpgoogledatasetsearchtaskpostrequestinfo)

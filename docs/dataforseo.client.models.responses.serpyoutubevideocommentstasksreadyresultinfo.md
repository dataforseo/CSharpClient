...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYoutubeVideoCommentsTasksReadyResultInfo](./dataforseo.client.models.responses.serpyoutubevideocommentstasksreadyresultinfo)

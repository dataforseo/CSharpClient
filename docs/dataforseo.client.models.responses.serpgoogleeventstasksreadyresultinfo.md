...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleEventsTasksReadyResultInfo](./dataforseo.client.models.responses.serpgoogleeventstasksreadyresultinfo)

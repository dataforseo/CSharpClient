...
```csharp
public class SerpGoogleEventsLiveAdvancedResultInfo
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleEventsLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogleeventsliveadvancedresultinfo.md)
...
```csharp
public SerpGoogleEventsLiveAdvancedResultInfo()
```

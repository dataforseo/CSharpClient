...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [OnPagePagesRequestInfo](./dataforseo.client.models.requests.onpagepagesrequestinfo.md)

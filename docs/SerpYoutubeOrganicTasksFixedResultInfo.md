...
**SeType** | **string** | <em>type of search engine</em><br>can take the following values: <code>{{low_se_type_under}}</code> |[optional]|
**DateFixed** | **string** | <em>date when the task was fixed (in the UTC format)</em> |[optional]|

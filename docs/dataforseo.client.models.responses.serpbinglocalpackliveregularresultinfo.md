...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingLocalPackLiveRegularResultInfo](./dataforseo.client.models.responses.serpbinglocalpackliveregularresultinfo)

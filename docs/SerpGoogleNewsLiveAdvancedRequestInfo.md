...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [SerpGoogleNewsLiveAdvancedRequestInfo](./SerpGoogleNewsLiveAdvancedRequestInfo.md)
...
```csharp
public SerpGoogleNewsLiveAdvancedRequestInfo()
```

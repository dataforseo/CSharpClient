...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataAppleAppListTaskPostRequestInfo](./dataforseo.client.models.requests.appdataappleapplisttaskpostrequestinfo.md)

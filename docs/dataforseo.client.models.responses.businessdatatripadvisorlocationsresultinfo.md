...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BusinessDataTripadvisorLocationsResultInfo](./dataforseo.client.models.responses.businessdatatripadvisorlocationsresultinfo)

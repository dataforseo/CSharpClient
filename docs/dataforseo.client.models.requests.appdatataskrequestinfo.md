...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataTaskRequestInfo](./dataforseo.client.models.requests.appdatataskrequestinfo)

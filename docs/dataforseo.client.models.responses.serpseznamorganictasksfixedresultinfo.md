...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpSeznamOrganicTasksFixedResultInfo](./dataforseo.client.models.responses.serpseznamorganictasksfixedresultinfo)

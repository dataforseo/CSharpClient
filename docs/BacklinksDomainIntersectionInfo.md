...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BacklinksDomainIntersectionInfo](./BacklinksDomainIntersectionInfo.md)
...
```csharp
public Nullable<int> LostDate { get; set; }
```

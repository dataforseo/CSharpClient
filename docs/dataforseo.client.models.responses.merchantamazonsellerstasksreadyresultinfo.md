...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantAmazonSellersTasksReadyResultInfo](./dataforseo.client.models.responses.merchantamazonsellerstasksreadyresultinfo.md)

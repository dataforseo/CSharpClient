...
```csharp
public class AppendixMinuteStatisticsMoneyData
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [AppendixMinuteStatisticsMoneyData](./AppendixMinuteStatisticsMoneyData.md)
...
```csharp
public AppendixMinuteStatisticsMoneyData()
```

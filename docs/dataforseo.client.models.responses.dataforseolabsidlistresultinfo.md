...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [DataforseoLabsIdListResultInfo](./dataforseo.client.models.responses.dataforseolabsidlistresultinfo.md)

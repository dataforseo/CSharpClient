...
**CheckUrl** | **string** | <em>direct URL to search engine results</em><br>in this case, equals <code>null</code> |[optional]|
...
**ItemTypes** | **IEnumerable<string>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>ads_search</code> |[optional]|
...
**Items** | **IEnumerable<AdsSearch>** | <em>items of the element</em> |[optional]|
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [AppendixLighthouseOnPageDayStatisticsRatesData](./AppendixLighthouseOnPageDayStatisticsRatesData.md)
...
```csharp
public Nullable<double> Audits { get; set; }
```

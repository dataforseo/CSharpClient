...
**Items** | **IEnumerable<AiOptimizationLlmMentionsTopMentionedDomainsLiveItem>** | individual domain results<br>array containing detailed mention metrics for each of the found top domains |[optional]|
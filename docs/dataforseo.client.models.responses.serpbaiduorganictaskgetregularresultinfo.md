...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBaiduOrganicTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpbaiduorganictaskgetregularresultinfo.md)
...
```csharp
public SerpBaiduOrganicTaskGetRegularResultInfo()
```

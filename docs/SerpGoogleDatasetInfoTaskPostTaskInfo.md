...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseResponseTaskInfo](./BaseResponseTaskInfo.md) → [SerpGoogleDatasetInfoTaskPostTaskInfo](./SerpGoogleDatasetInfoTaskPostTaskInfo.md)
...
```csharp
public SerpGoogleDatasetInfoTaskPostTaskInfo()
```

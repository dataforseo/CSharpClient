...
**NewsType** | **string** | financial news filters<br>optional field<br>possible values: top_stories, local_market, world_markets<br>default value: top_stories |[optional]|

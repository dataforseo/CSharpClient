...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleDatasetInfoLiveAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogledatasetinfoliveadvancedresultinfo)

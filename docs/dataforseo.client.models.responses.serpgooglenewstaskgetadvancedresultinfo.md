...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleNewsTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpgooglenewstaskgetadvancedresultinfo.md)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYahooLocationsResultInfo](./dataforseo.client.models.responses.serpyahoolocationsresultinfo)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBaiduOrganicTasksFixedResultInfo](./dataforseo.client.models.responses.serpbaiduorganictasksfixedresultinfo)

...
```csharp
public class AppendixMinuteStatisticsRatesData
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [AppendixMinuteStatisticsRatesData](./AppendixMinuteStatisticsRatesData.md)
...
```csharp
public AppendixMinuteStatisticsRatesData()
```

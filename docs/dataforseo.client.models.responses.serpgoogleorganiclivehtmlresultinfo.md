...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleOrganicLiveHtmlResultInfo](./dataforseo.client.models.responses.serpgoogleorganiclivehtmlresultinfo)

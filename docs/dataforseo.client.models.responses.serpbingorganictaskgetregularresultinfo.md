...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingOrganicTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpbingorganictaskgetregularresultinfo)

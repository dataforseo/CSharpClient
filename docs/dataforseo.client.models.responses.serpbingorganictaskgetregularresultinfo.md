...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpBingOrganicTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpbingorganictaskgetregularresultinfo.md)
...
types of search results in SERP
 ...
 <br>possible item types: organic, paid
...
```csharp
public SerpBingOrganicTaskGetRegularResultInfo()
```

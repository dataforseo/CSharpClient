...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BacklinksDomainIntersectionLiveRequestInfo](./BacklinksDomainIntersectionLiveRequestInfo.md)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantGoogleProductsTaskGetHtmlResultInfo](./dataforseo.client.models.responses.merchantgoogleproductstaskgethtmlresultinfo)

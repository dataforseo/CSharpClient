...
**Items** | **IEnumerable<AiOptimizationLlmMentionsTopMentionedBrandsLiveItem>** | <em>individual domain results</em><br>array containing detailed mention metrics for each of the found top domains |[optional]|
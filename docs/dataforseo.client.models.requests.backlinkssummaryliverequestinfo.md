...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BacklinksSummaryLiveRequestInfo](./dataforseo.client.models.requests.backlinkssummaryliverequestinfo.md)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [DomainAnalyticsErrorsResultInfo](./dataforseo.client.models.responses.domainanalyticserrorsresultinfo)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [MerchantGoogleProductInfoTaskPostRequestInfo](./dataforseo.client.models.requests.merchantgoogleproductinfotaskpostrequestinfo)

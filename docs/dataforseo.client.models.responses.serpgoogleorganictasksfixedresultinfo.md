...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleOrganicTasksFixedResultInfo](./dataforseo.client.models.responses.serpgoogleorganictasksfixedresultinfo.md)

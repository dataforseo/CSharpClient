...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYoutubeVideoInfoTasksFixedResultInfo](./dataforseo.client.models.responses.serpyoutubevideoinfotasksfixedresultinfo)

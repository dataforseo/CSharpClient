...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseAppDataSerpElementItem](./BaseAppDataSerpElementItem.md) → [AppDataGooglePlayReviewsSearchSerpElementItem](./AppDataGooglePlayReviewsSearchSerpElementItem.md)
...
[ICollection&lt;ResponseDataInfo&gt;](./ResponseDataInfo.md)<br>

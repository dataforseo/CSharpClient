...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [OnPageErrorsRequestInfo](./dataforseo.client.models.requests.onpageerrorsrequestinfo)

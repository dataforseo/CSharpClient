...
**Directory** | **BusinessDirectoryInfo** | <em>items of the directory</em><br>includes information about businesses that are located within the target business establishment and have the same address |[optional]|

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpYahooOrganicTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpyahooorganictaskgetregularresultinfo.md)
...
```csharp
public SerpYahooOrganicTaskGetRegularResultInfo()
```

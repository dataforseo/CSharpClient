...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BacklinksAnchorsLiveItem](./dataforseo.client.models.backlinksanchorsliveitem.md)

...
**PriceMultiplier** | **int?** | <em>price multiplier for instalment plan</em><br>indicates the number of months covered by the monthly payment for the product |[optional]|
...
**IsBestMatch** | **bool?** | <em>'best match' label</em><br>if the value is <code>true</code>, the product is marked with the 'best match' label<br>if there are no values, you will get <code>null</code> |[optional]|

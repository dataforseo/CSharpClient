...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [BusinessDataGoogleLocationsResultInfo](./dataforseo.client.models.responses.businessdatagooglelocationsresultinfo.md)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleImagesTaskGetAdvancedResultInfo](./dataforseo.client.models.responses.serpgoogleimagestaskgetadvancedresultinfo)

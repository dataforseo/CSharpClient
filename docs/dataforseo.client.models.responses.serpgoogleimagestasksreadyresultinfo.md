...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpGoogleImagesTasksReadyResultInfo](./dataforseo.client.models.responses.serpgoogleimagestasksreadyresultinfo)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SerpNaverOrganicTaskGetRegularResultInfo](./dataforseo.client.models.responses.serpnaverorganictaskgetregularresultinfo)

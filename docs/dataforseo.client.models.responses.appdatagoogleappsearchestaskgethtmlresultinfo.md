...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [AppDataGoogleAppSearchesTaskGetHtmlResultInfo](./dataforseo.client.models.responses.appdatagoogleappsearchestaskgethtmlresultinfo)

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseYoutubeSerpElementItem](./BaseYoutubeSerpElementItem.md) → [YoutubeVideoInfoSerpElementItem](./YoutubeVideoInfoSerpElementItem.md)
...
```csharp
public Nullable<bool> IsEmbeddable { get; set; }
```
...
[ICollection&lt;StreamingQualityElement&gt;](./StreamingQualityElement.md)<br>

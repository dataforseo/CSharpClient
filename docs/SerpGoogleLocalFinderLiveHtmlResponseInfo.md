...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BaseResponseInfo](./BaseResponseInfo.md) → [SerpGoogleLocalFinderLiveHtmlResponseInfo](./SerpGoogleLocalFinderLiveHtmlResponseInfo.md)
...
[ICollection&lt;SerpGoogleLocalFinderLiveHtmlTaskInfo&gt;](./SerpGoogleLocalFinderLiveHtmlTaskInfo.md)<br>

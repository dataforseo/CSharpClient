...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [BusinessDataTripadvisorReviewsTaskPostRequestInfo](./BusinessDataTripadvisorReviewsTaskPostRequestInfo.md)
...
```csharp
public Nullable<bool> TranslateReviews { get; set; }
```

...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/Object) → [KeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo](./KeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo.md)
...
[KeywordAnnotations](./KeywordAnnotations.md)<br>

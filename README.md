...
- AI Optimization API ([source docs](https://github.com/dataforseo/CSharpClient/blob/master/Api/AiOptimizationApi.md) | [api docs](https://docs.dataforseo.com/v3/ai_optimization/overview/))

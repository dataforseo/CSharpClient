...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationPerplexityLlmResponsesLiveResultInfo 
    {
        ...
        /// <br/>the price charged by the third-party AI model provider for according to its <see href="https://docs.perplexity.ai/guides/pricing">Pricing</see>
        /// </summary>

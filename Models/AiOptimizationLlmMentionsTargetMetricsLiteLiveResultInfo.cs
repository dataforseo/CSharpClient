...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationLlmMentionsTargetMetricsLiteLiveResultInfo 
    {
        ...
        /// <br/>contains objects with aggregated mention metrics for the specified target
        /// </summary>
        [JsonProperty("items", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<AiOptimizationLlmMentionsTargetMetricsLiteLiveItem> Items { get; set; }

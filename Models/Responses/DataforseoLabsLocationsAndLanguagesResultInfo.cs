...
namespace DataForSeo.Client.Models.Responses
{
    ...
    public partial class DataforseoLabsLocationsAndLanguagesResultInfo
    {
        /// <summary>
        /// location code
        /// </summary>
        [Newtonsoft.Json.JsonProperty("location_code", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]

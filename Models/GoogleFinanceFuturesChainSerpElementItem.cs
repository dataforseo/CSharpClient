...
namespace DataForSeo.Client.Models
{
    ...
    public class GoogleFinanceFuturesChainSerpElementItem  : BaseGoogleFinanceSerpElementItem 
    {
        ...
        public IEnumerable<GoogleFinanceFuturesChainMarkets> Markets { get; set; }

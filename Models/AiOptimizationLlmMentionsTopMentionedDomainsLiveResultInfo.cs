...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedDomainsLiveResultInfo 
    {
        ...
        public IEnumerable<AiOptimizationLlmMentionsTopMentionedDomainsLiveItem> Items { get; set; }

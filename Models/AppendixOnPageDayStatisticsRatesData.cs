...
namespace DataForSeo.Client.Models
{
    ...
    public class AppendixOnPageDayStatisticsRatesData 
    {
        ...
        [JsonProperty("microdata", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("force_stop", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]

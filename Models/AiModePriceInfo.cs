...
namespace DataForSeo.Client.Models
{
    ...
    public class AiModePriceInfo 
    {

        /// <summary>
        /// current price
        /// <br/>indicates the current price of the shopping element
        /// </summary>
        ...
        /// <summary>
        /// regular price
        /// <br/>indicates the regular price of the shopping element
        /// </summary>
        ...
        /// <summary>
        /// the maximum price
        /// <br/>indicates the maximum price of the shopping element
        /// </summary>

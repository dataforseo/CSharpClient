namespace DataForSeo.Client.Models
{
    ...
    public partial class BacklinksDomainIntersectionInfo
    {
        /// <summary>
        /// type of element
        /// </summary>
        ...
        /// <br/>indicates the rank that the referring domain (target above) refers to your target from the POST array;

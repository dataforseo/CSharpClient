...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedPagesLiteLiveResultInfo 
    {
        ...
        public IEnumerable<AiOptimizationLlmMentionsTopMentionedPagesLiteLiveItem> Items { get; set; }

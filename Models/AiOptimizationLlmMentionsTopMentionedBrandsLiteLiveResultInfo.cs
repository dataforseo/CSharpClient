...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveResultInfo 
    {
        ...
        public IEnumerable<AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveItem> Items { get; set; }

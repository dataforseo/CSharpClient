...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveItem 
    {

        /// <summary>
        /// brand category
        /// <br/>brand category found in LLM mentions for the specified target
        /// </summary>
        [JsonProperty("brand_category", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]

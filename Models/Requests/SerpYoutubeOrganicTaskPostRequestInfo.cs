...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class SerpYoutubeOrganicTaskPostRequestInfo 
    {
        ...
        /// <br/>available values: desktop, mobile
        /// </summary>
        ...
        /// parsing depth
        /// <br/>optional field
        /// <br/>number of blocks of results in SERP
        /// <br/>default value: 20
        /// <br/>max value: 700
        /// <br/>Note: your account will be billed per each SERP containing up to 20 blocks of results;
        /// <br/>thus, setting a block depth above 20 may result in additional charges if the search engine returns more than 20 results;
        /// <br/>if the specified block depth is higher than the number of results in the response, the difference will be refunded automatically to your account balance
        /// </summary>
        [JsonProperty("block_depth", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]

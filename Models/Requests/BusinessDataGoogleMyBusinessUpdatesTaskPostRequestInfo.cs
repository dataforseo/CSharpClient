...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class BusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo 
    {
        ...
        /// <br/>if you need to use the “%” character for your <c>keyword</c>, please specify it as “%25”;this field can also be used to pass <c>cid</c> (unique, google-defined id of the business entity) or <c>place_id</c> (identifier of the business entity in Google Maps) parameters
        /// <br/>example:

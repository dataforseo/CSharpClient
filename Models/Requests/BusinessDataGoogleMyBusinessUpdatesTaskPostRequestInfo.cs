...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public partial class BusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo
    {
        /// <summary>
        /// keyword
        /// <br/>required field
        ...
        /// <br/>if you need to use the “%” character for your keyword, please specify it as “%25”;this field can also be used to pass cid (unique, google-defined id of the business entity) or place_id (identifier of the business entity in Google Maps) parameters
        /// <br/>example:

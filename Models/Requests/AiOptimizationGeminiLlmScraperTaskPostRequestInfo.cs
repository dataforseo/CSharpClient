...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationGeminiLlmScraperTaskPostRequestInfo 
    {
        ...
        /// <br/>The cost can be calculated on the <see href="https://dataforseo.com/pricing/ai-optimization/llm-scraper">Pricing</see> page.
        /// </summary>
        ...
        /// <br/>you can receive the list of available locations of the search engine with their <c>location_name</c> by making a separate request to the <c>https://api.dataforseo.com/v3/ai_optimization/gemini/llm_scraper/locations</c>
        /// <br/>example:
        ...
        /// <br/>you can receive the list of available locations of the search engines with their <c>location_code</c> by making a separate request to the <c>https://api.dataforseo.com/v3/ai_optimization/gemini/llm_scraper/locations</c>
        /// <br/>example:
        /// <br/><c>2840</c>
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages of the search engine with their <c>language_name</c> by making a separate request to the <c>https://api.dataforseo.com/v3/ai_optimization/gemini/llm_scraper/languages</c>
        /// <br/>example:
        /// <br/><c>English</c>
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages of the search engine with their <c>language_code</c>_by making a separate request to the <c>https://api.dataforseo.com/v3/ai_optimization/gemini/llm_scraper/languages</c>
        /// <br/>example:
        /// <br/><c>en</c>
        /// </summary>

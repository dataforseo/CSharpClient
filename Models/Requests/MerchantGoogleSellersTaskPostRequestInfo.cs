...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class MerchantGoogleSellersTaskPostRequestInfo 
    {
        ...
        /// <br/>example:
        /// <br/><c>Eg4iBWNvbG9yKgV3aGl0ZRISIgxwYWNrYWdlIHNpemUqAjE0EgoiBHNpemUqAnhs</c>
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if set to <c>true</c>, the response will contain the list of sellers that allow to purchase a given product directly on Google
        /// <br/>Note: if set to <c>true</c>, the cost of a task will be doubled
        /// </summary>
        ...
        /// <br/>you can get additional information about the product by using the <c>'additional_specifications</c> object, which you can get by making a separate request to the <see href="/v3/merchant/google/products/task_post">Google Shopping Products endpoint</see>
        /// <br/>example:
        /// <br/><c>'additional_specifications': {'eto': '16157121050167572763_0'}</c>
        /// </summary>

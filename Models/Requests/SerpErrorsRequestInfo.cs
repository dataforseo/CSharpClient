...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class SerpErrorsRequestInfo 
    {
        ...
        /// <br/>default and minimum value: <c>0</c>
        ...
        /// <br/>use this field to obtain a list of tasks that returned an error filtered by the certain endpoint's URL, as well as <c>pingback_url</c> or <c>postback_url</c> specified in the API request;
        ...
        /// <br/>example: <c>serp/task_get/advanced</c>
        /// </summary>
        ...
        /// <br/>must be specified in the UTC format: <c>'yyyy-mm-dd hh-mm-ss +00:00'</c>;
        /// <br/>minimum value: 7 days from the current <c>datetime</c>
        /// <br/>maximum value: current <c>datetime</c>
        /// <br/>example:
        ...
        /// <br/>minimum value: 7 days from the current <c>datetime</c>
        /// <br/>maximum value: current <c>datetime</c>
        /// <br/>Note <c>datetime_to</c> must be greater than <c>datetime_from</c> if both parameters are used;
        /// <br/>example:

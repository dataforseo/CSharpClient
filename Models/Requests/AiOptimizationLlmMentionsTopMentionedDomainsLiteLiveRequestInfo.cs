...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo 
    {
        ...
        /// <br/>you can receive the list of available languages of the search engine with their language_code_by making a separate request to the https://api.dataforseo.com/v3/ai_optimization/llm_mentions/locations_and_languages
        /// <br/>default value: en
        /// <br/>Note: chat_gpt data is available for en onlyn
        /// </summary>
        ...
        /// <br/>Note: if the platform is not specified, the data is returned for both platforms
        ...
        /// <br/>example:
        /// <br/>['ai_search_volume','&gt;',1000]The full list of possible filters is available here.
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>you can use this array to filter expressions applied to the raw mentions database before aggregation to limit the rows contributing to the result;you can add several filters at once (8 filters maximum)
        /// <br/>you should set a logical operator and, or between the conditions
        /// <br/>the following operators are supported:
        /// <br/>=, &lt;&gt;, in, not_in, like, not_like, ilike, not_ilike, match, not_match
        /// <br/>you can use the % operator with like and not_like to match any string of zero or more characters
        ...
        /// <br/>optional fielddefault value: 0
        ...
        /// <br/>Note: the maximum value is 1000000
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if specified, only the listed domains will be returned in the items array
        /// <br/>example:
        /// <br/>['dataforseo.com','seoinsider.com']
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if specified, the listed domains will be omitted from the items array
        /// <br/>example:
        /// <br/>['google.com','bing.com']
        /// </summary>

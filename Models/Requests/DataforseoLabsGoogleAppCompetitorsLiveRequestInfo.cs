...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class DataforseoLabsGoogleAppCompetitorsLiveRequestInfo 
    {
        ...
        /// <br/>example:
        /// <br/><c>['intersections','&gt;',500]</c>
        /// <br/><c>[['competitor_metrics.google_play_search_organic.pos_1','&lt;&gt;',10],'and',['avg_position','&gt;=','10']]</c>
        /// <br/><c>[[['intersections','&gt;=',50],'and',['competitor_metrics.google_play_search_organic.pos_1','in',[1,5]]],'or',['sum_position','&gt;=','10000']]</c>
        ...
        /// <br/>if you specify the <c>10</c> value, the first ten apps in the results array will be omitted and the data will be provided for the successive keywords
        /// </summary>

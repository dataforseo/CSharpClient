...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class MerchantAmazonReviewsTaskPostRequestInfo 
    {
        ...
        /// </summary>
        [JsonProperty("reviewer_type", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("filter_by_star", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("filter_by_keyword", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("format_type", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]

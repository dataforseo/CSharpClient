...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AppDataAppleAppInfoTaskPostRequestInfo 
    {
        ...
        /// <br/>you can receive the list of available locations of the search engine with their <c>location_name</c> by making a separate request to `https://api.dataforseo.com/v3/app_data/apple/locations`
        /// <br/>example:
        ...
        /// <br/>you can receive the list of available locations of the search engine with their <c>location_code</c> by making a separate request to `https://api.dataforseo.com/v3/app_data/apple/locations`
        /// <br/>example:
        /// <br/><c>9061121</c>
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages with <c>language_name</c> by making a separate request to `https://api.dataforseo.com/v3/app_data/apple/languages`
        /// <br/>example:
        /// <br/><c>English</c>
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages with their <c>language_code</c>_by making a separate request to `https://api.dataforseo.com/v3/app_data/apple/languages`
        /// <br/>example:
        /// <br/><c>en</c>
        /// </summary>
        ...
        /// <br/>2 – high execution priority You will be additionally charged for the tasks with high execution priority.

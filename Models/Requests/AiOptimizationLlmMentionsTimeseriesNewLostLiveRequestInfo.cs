...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo 
    {
        ...
        /// <br/>required field
        /// <br/>Note:the value specified in date_from cannot exceed the value in date_to
        /// <br/>date format: 'yyyy-mm-dd'
        /// </summary>

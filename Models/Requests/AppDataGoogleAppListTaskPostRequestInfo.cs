...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AppDataGoogleAppListTaskPostRequestInfo 
    {
        ...
        /// <br/><c>featured</c>, <c>topselling_paid</c>, <c>topselling_free</c>, <c>topselling_new_free</c>, <c>topselling_new_paid</c>, <c>topgrossing</c>, <c>movers_shakers</c>
        /// <br/>Note: if <c>featured</c> is selected, the <c>app_category</c> parameter cannot be used
        /// </summary>
        ...
        /// <br/>you can receive the list of available languages with their <c>language_code</c>_by making a separate request to <c>https://api.dataforseo.com/v3/app_data/google/languages</c>
        /// <br/>example:
        /// <br/><c>en</c>
        /// </summary>
        ...
        /// <br/>example:
        /// <br/><c>family</c>;
        /// <br/>you can receive the full list of available categories by making a separate request to <c>https://api.dataforseo.com/v3/app_data/google/categories</c>
        /// <br/>Note: <c>app_category</c> cannot be used if <c>app_collection</c> parameter is set to <c>featured</c>
        /// </summary>
        ...
        /// <br/><c>ages_up_to_5</c> — return apps approved for children up to 5 years old;
        /// <br/><c>ages_6_8</c> — return apps approved for children from 6 to 8 years old;
        /// <br/><c>ages_9_12</c> — return apps approved for children from 9 to 12 years old;
        /// <br/>by default, the API returns apps for all ages;
        /// <br/>Note: this filter works only in conjunction with the <c>'category': 'family'</c> parameter
        /// </summary>

...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class DataforseoLabsGoogleCategoriesForDomainLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if set to <c>false</c>, the subcategories will be ignored
        /// <br/>default value: <c>false</c>
        /// <br/>learn more about the parameter in this <see href="https://dataforseo.com/help-center/include_subcategories-in-categories-for-domain-endpoint">help center article</see>
        /// </summary>
        [JsonProperty("include_subcategories", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <br/>example:
        /// <br/><c>['metrics.organic.pos_1,'&gt;',0]</c>
        /// <br/><c>[[['metrics.organic.count','&gt;=',100],'and',['metrics.organic.pos_1','&gt;',0]],'or',['metrics.organic.etv','in',[10,100]]]</c>
        ...
        /// <br/>Note: if the <c>item_types</c> array contains item types that are different from the <c>organic</c> object, the results will be ordered by the first item type in the array
        /// </summary>
        ...
        /// <br/>if you specify the <c>10</c> value, the first ten categories in the results array will be omitted and the data will be provided for the successive categories
        /// </summary>

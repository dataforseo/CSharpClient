...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class SerpGoogleFinanceMarketsLiveAdvancedRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>possible values: <c>most-active</c>, <c>indexes</c>, <c>indexes/americas</c>, <c>indexes/europe-middle-east-africa</c>, <c>indexes/asia-pacific</c>, <c>gainers</c>, <c>losers</c>, <c>climate-leaders</c>, <c>cryptocurrencies</c>, <c>currencies</c>
        /// <br/>default value: <c>most-active</c>
        /// </summary>

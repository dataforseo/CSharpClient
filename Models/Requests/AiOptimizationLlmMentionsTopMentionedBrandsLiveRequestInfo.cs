...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if specified, only the listed brands will be returned in the items array
        /// <br/>example:
        /// <br/>'include_brands': ['Audi']
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if specified, the listed brands will be omitted from the items array
        /// <br/>example:
        /// <br/>'exclude_brands': ['Audi']
        /// </summary>

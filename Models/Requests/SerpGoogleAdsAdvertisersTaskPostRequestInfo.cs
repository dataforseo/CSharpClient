...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class SerpGoogleAdsAdvertisersTaskPostRequestInfo 
    {
        ...
        /// <br/>The cost can be calculated on the <see href="https://dataforseo.com/pricing/serp/google-ads-advertisers-serp-api">Pricing</see> page.
        /// </summary>
        ...
        /// <br/>you can receive the list of available locations of the search engines with their <c>location_code</c> by making a separate request to the <c>https://api.dataforseo.com/v3/serp/google/ads_advertisers/locations</c>
        /// <br/>example:
        /// <br/><c>2840</c>
        /// <br/>Note: if you don't specify <c>location_name</c>, <c>location_code</c>, or <c>location_coordinate</c>, advertisers will be searched across all the available locations
        /// </summary>
        ...
        /// <br/>you can receive the list of available locations of the search engine with their <c>location_name</c> by making a separate request to the <c>https://api.dataforseo.com/v3/serp/google/ads_advertisers/locations</c>
        /// <br/>example:

...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public partial class SerpBingLocalPackTaskPostRequestInfo
    {
        /// <summary>
        ...
        /// <br/>you can receive the list of available locations of the search engine with their language_name by making a separate request to the https://api.dataforseo.com/v3/serp/bing/languages
        /// <br/>example:
        /// <br/>English
        /// </summary>
        ...
        /// <br/>you can receive the list of available locations of the search engine with their language_code by making a separate request to the https://api.dataforseo.com/v3/serp/bing/languages
        /// <br/>example:
        /// <br/>en
        /// </summary>

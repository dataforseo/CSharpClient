...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class SerpGoogleNewsLiveHtmlRequestInfo 
    {
        ...
        /// <br/>you can receive the list of available locations of the search engine with their <c>language_code</c> by making a separate request to the <c>https://api.dataforseo.com/v3/serp/{{low_se_name}}/languages</c>
        /// <br/>example:
        /// <br/><c>en</c>
        /// </summary>
        ...
        /// <br/>The cost can be calculated on the <see href="https://dataforseo.com/pricing/serp/google-news-serp-api">Pricing</see> page.
        /// </summary>
        ...
        /// <br/>you can receive the list of available locations of the search engine with their <c>language_name</c> by making a separate request to the <c>https://api.dataforseo.com/v3/serp/{{low_se_name}}/languages</c>
        /// <br/>example:
        /// <br/><c>English</c>
        /// </summary>

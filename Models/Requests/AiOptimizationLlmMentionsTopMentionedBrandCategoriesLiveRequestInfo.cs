...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if specified, only the listed brand categories will be returned in the items array
        /// <br/>example:
        /// <br/>'include_brand_categories': ['business']
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if specified, the listed brand categories will be omitted from the items array
        /// <br/>example:
        /// <br/>'exclude_brand_categories': ['business']
        /// </summary>

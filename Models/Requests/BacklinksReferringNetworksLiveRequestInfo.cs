...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class BacklinksReferringNetworksLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>possible values: <c>ip</c>, <c>subnet</c>
        /// <br/>default value: <c>ip</c>
        /// </summary>
        [JsonProperty("network_address_type", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <br/>example:
        /// <br/><c>['referring_pages','&gt;','1']</c>
        /// <br/><c>[['referring_pages','&gt;','2'],'and',['backlinks','&gt;','10']]</c>
        /// <br/><c>[['first_seen','&gt;','2017-10-23 11:31:45 +00:00'],'and',[['network_address','like','194.1.%'],'or',['referring_ips','&gt;','10']]]</c>
        ...
        /// <br/>optional field
        /// <br/>if set to <c>false</c>, the backlinks from subdomains of the <c>target</c> will be ommited and you won't receive the same domain in the response;
        /// <br/>default value: <c>true</c>
        /// </summary>

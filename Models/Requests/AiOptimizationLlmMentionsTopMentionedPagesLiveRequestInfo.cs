...
namespace DataForSeo.Client.Models.Requests
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo 
    {
        ...
        /// <br/>optional field
        /// <br/>if specified, only the listed pages will be returned in the items array
        /// <br/>example:
        /// <br/>'include_pages': ['https://example.page/']
        /// </summary>
        ...
        /// <br/>optional field
        /// <br/>if specified, the listed pages will be omitted from the items array
        /// <br/>example:
        /// <br/>'exclude_pages': ['https://example.page/']
        /// </summary>

...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveResultInfo 
    {
        ...
        /// <br/>contains aggregated LLM mention metrics across all found brand categories, grouped by various dimensions
        /// </summary>
        ...
        /// <br/>array containing detailed mention metrics for each of the found brand categories
        /// </summary>
        [JsonProperty("items", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveItem> Items { get; set; }

...
namespace DataForSeo.Client.Models
{
    ...
    public class AiOptimizationClaudeLlmResponsesTaskGetResultInfo 
    {
        ...
        /// <br/>the price charged by the third-party AI model provider for according to its <see href="https://docs.anthropic.com/en/docs/about-claude/pricing">Pricing</see>
        /// </summary>
